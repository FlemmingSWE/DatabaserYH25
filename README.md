...
En kund ska ha möjligheten att göra flera beställningar. En beställning kan därmed innehålla en eller flera böcker. Orderraderns syfte är alltså att beskriva vilken bok som tillhör vems beställning.

ER-diagrammet finns i mappen "/images" och går under namnet "ER_diagram_inlämning1.png"
